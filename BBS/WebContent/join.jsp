...
<body>
 ...
 <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
  <ul class="nav navbar-nav">
   <li><a href="main.jsp">メイン</a>
   <li><a href="bbs.jsp">掲示板</a>
  </ul>
  ...
  <div class="col-lg-4">
   ...
   <form method="post" action="joinAction.jsp">
    ...
    <div class="form-group">
     <input type="password" class="form-control" placeholder="パスワード" name="userPassword" maxlength="20">     
    </div>
    <div class="form-group">
    ...
    <div class="form-group"style="text-align:center;">
     <div class="btn-group" data-toggle="buttons">
     	...
     	<label class="btn btn-primary">
     		<input type="radio" name="userGender" autocomplete="on" value="女性"checked>女性
     	</label>
     </div>	
    </div>
