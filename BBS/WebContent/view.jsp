...
%>
    <nav class ="navbar navbar-default">
        <div class="navbar-header"> <!-- 홈페이지의 로고 -->
            ...
            <a class ="navbar-brand" href="main.jsp">JSP 掲示板ウェブサイト</a>
        </div>
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <a href="#" class = "dropdown-toggle"
                    ...
                    aria-expanded="false">ログイン<span class="caret"></span></a>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <a href="#" class = "dropdown-toggle"
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="loginAction.jsp">ログアウト</a></li>
                    </ul>
                </li>
            </ul>
            <%
    ...
    <div class="container">
        <div class="row">
            <table class="table table-striped" style="text-align:center; border:1px solid #dddddd">
                <thead>
                    <tr>
                        <th colspan="3" style="background-color:#eeeeee; text-align:center;">掲示板閲覧</th>
            ...
            <a href="bbs.jsp" class="btn btn-primary">目次</a>
            <%
                if(userID != null && userID.equals(bbs.getUserID()))
                {
            %>
                <a href="update.jsp?bbsID=<%=bbsID %>" class="btn btn-primary">修正</a>
                <a onclick="return confirm('削除しますか？')" href="deleteAction.jsp?bbsID=<%=bbsID %>" class="btn btn-primary">削除</a>
